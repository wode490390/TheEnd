package cn.wode490390.nukkit.theend.noise;
...
public class PerlinNoiseGenerator extends NoiseGenerator {
    ...
    public double noise(double x, double y, double z) {
        ...
        return NoiseGenerator.lerp(fZ, NoiseGenerator.lerp(fY, NoiseGenerator.lerp(fX, NoiseGenerator.grad(this.perm[AA], x, y, z), NoiseGenerator.grad(this.perm[BA], x - 1, y, z)), NoiseGenerator.lerp(fX, NoiseGenerator.grad(this.perm[AB], x, y - 1, z), NoiseGenerator.grad(this.perm[BB], x - 1, y - 1, z))), NoiseGenerator.lerp(fY, NoiseGenerator.lerp(fX, NoiseGenerator.grad(this.perm[AA + 1], x, y, z - 1), NoiseGenerator.grad(this.perm[BA + 1], x - 1, y, z - 1)), NoiseGenerator.lerp(fX, NoiseGenerator.grad(this.perm[AB + 1], x, y - 1, z - 1), NoiseGenerator.grad(this.perm[BB + 1], x - 1, y - 1, z - 1))));
    }
